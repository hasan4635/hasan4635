...
UPDATE september 24 for iOS please use the file package-ios.json
...
2. make sure you choose IOS 5.1.1 and  Xcode 11.3 
...
this will be lost or replace by monaca if you go to ios build settings and saved
